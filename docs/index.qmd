...
The method and the reference implementation are by Shosei Sakaguchi and
Hayato Tagawa; this package is an independent Python port with
paper-correct defaults, developed at the [QuaRCS lab](https://quarcs-lab.org).
