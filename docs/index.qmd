...
If you use scspill, please cite it as:
...
The `sar` model is cross-validated against the MIT-licensed [replication
package](https://doi.org/10.5281/zenodo.19066186) for the article it
implements. scspill is developed at the [QuaRCS lab](https://quarcs-lab.org).
