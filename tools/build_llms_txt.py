...
PAGES = [
    ...
    ("Models: catalogue and roadmap", "models/index.qmd", "models/index.html"),
    ("The `sar` model (Sakaguchi & Tagawa)", "models/sar.qmd", "models/sar.html"),
...
def canonical() -> str:
    ...
    lines = [
        ...
        f"Catalogue: {BASE}/models/index.html",
        "",
